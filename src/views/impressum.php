...
<head>
    ...
    <link rel="stylesheet" href="../public/styles/impressum.css">
...
<body>
    <main class="main">
        ...
        <p><strong>MacApple GmbH</strong><br>
            Example Straße 12<br>
            12345 Musterstadt<br>
            Deutschland</p>
        <h3>Vertreten durch:</h3>
        <p>John Doe (Geschäftsführer)</p>
        <h3>Kontakt:</h3>
        <p>Telefon: +49 (0)123 456 7890<br>
            E-Mail: <a href="mailto:contact@macapple.de">contact@macapple.de</a><br>
            Website: <a href="https://www.macapple.de">www.macapple.de</a></p>
